...
namespace Demos.BookManagement.LiteDbRepository.Tests
{
    [TestClass]
    public class BookRepositoryUnitTest
    {
        ...
        {
            //arrange
            var before = _repository.FindById(_book.Id);
            var expected = "图书";
            before.Title = expected;
            //act
            _repository.Modify(before);
            var after = _repository.FindById(_book.Id);
            //assert
